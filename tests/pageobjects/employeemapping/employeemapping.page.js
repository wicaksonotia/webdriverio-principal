...
class EmployeeMappingPage extends Page {
    ...
    get cellNamaEmployee () { return $$('#columnTitle') }
    get employee () { return $$('#cellName') }
    get email () { return $$('#cellEmail') }
    get area () { return $$('#cellArea') }
    get metode () { return $$('#cellMetode') }
    ...
    async searchResult (email) {
        await browser.waitUntil(
            async () => (await (this.email[0]).isExisting()),
            {
                timeout: 20000,
