...
class FormEmployeeMappingPage extends Page {
    ...
    get inpName () { return $('#field-pic_name') }
    get clrName () { return $('[title="Clear"]') }
    get valueName () { return $('input[class="MuiInputBase-input MuiInput-input MuiAutocomplete-input MuiAutocomplete-inputFocused MuiInputBase-inputAdornedEnd"]') }
    get drpdwn () { return $$('#fieldSelect') }
    get drpdwnValue () { return $$('#checkbox') }
    get drpdwnMetode () { return $$('#field-payment_method') }
    get drpdwnMetodeValue () { return $$('#list-payment_method') }
    
    //Notifikasi Tambahan
    get notif () { return $$('div[class="MuiSnackbarContent-message"]') }
