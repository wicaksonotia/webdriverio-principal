...
class CoinRedemptionApprovalPage extends Page {
    ...
    get cellGTP () { return $$('#cellGTP') } 
    get cellWBS () { return $$('#cellWBS') } 
    get cellStatus () { return $$('#cellStatus') } 
    get btnSetujui () { return $$('#btnApprove') }
    get btnTolak () { return $$('#btnReject') }
    ...
    async dialogConfirmApprove (){
        ...
        await expect(this.dialogCaption).toHaveTextContaining('Apakah Anda menyetujui request penukaran coin ini?')
    ...
    async dialogConfirmReject (){
        await this.dialogTitle.waitForExist();
        await expect(this.dialogCaption).toHaveTextContaining('Apakah Anda menolak request penukaran coin ini?')
        await this.btnConfirm.click()
    }
