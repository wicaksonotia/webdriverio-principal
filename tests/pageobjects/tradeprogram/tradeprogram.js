...
class TradeProgramPage extends Page {
    ...
    get btnFilter () {return $$('[type="button"]')}
    ...
    async detailTradeProgram () {  //click name
        await this.dataRow.$$('option')[25].click();
    }

    async editTradeProgram () {    //click edit button
        await this.btnEdit.$$('option')[25].click();
    }

    async editTradeProgram (namaTemplate) {  //detail by click name
