...
class FormFieldForcePage extends Page {
    ...
    get titlePage () { return $('#headerFieldForce') }

    get name () { return $('[formcontrolname="name"]') }
    get username () { return $('[formcontrolname="username"]') }
    get type () { return $('[formcontrolname="type"]') }
    get option () { return $$('[role="option"]') }
    get classification () { return $('[formcontrolname="classification"]') }
    ...
    get status () { return $('[formcontrolname="status"]') }
    ...
    async pageCreate () {
        ...
        await expect(browser).toHaveUrlContaining('user-management/field-force/create')
    }
