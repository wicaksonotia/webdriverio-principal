...
class createNotifikasiEmployee extends Page {

    //define selectors using getter methods
    get titlePage () {return $('#headerNotifikasi')}
    get formcntPage () {return $('#contentHeader > div > div.middle-container')}
    ...
    get employeeOnly () {return $$('[formcontrolname="employee"]')}
    get optionTipeEmployee () {return $$('[role="option"]')} 
    ...
    async tipeEmployee () {
        ...
        await this.optionTipeEmployee[65].click()
    }
...
export default new createNotifikasiEmployee ();