...
class createNotifikasiPushLangganan extends Page {
    ...
    get optionTipeBerlangganan () {return $$('[role="option"]')}
    ...
    async tipeBerlangganan () {
        ...
        await this.optionTipeBerlangganan[65].click()
    }
...
export default new createNotifikasiPushLangganan ();