...
class createNotifikasiPushCc extends Page {

    //define selectors using getter methods
     get titlePage () {return $('#headerNotifikasi')}
     get formcntPage () {return $('#wrapper > div > fuse-content > app-notification-create > div > div.content.p-24 > div > form > div:nth-child(1) > h2')}
...
export default new createNotifikasiPushCc();