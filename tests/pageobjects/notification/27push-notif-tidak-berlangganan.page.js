...
class createNotifikasiPushTdkLangganan extends Page {
    ...
    get listBoxStatusBerlangganan () {return $$('#subscription_status')}
    get optionTipeTidakBerlangganan () {return $$('[role="option"]')}
    get radioBtnTipeKonten () {return $$('#mat-radio-10')} 
...
export default new createNotifikasiPushTdkLangganan ();