...
class SubGTPPage extends Page {
    ...
    get MenuSgpt () {return $('#menu-243')}
    //Table
    get datatableBody () { return $('div.MuiDataGrid-renderingZone') }
    get dataRow () { return $$('div.MuiDataGrid-row') }
    
    get cellNama () { return $$('#columnTitle') }
    get nama () { return $$('#cellName') }
    get wbs () { return $$('#cellWBS') }
    get approver () { return $$('#cellApprover') }
    get status () { return $$('#cellStatus') }
    
    get btnEdit () { return $$('#btnEdit') }
    get btnDelete () { return $$('#btnDelete') }
    get notifMessage () { return $$('#notifMessage') }
    ...
    async searchResult (nama) {
        await browser.waitUntil(
            async () => (await (this.nama[0]).isExisting()),
            {
                timeout: 20000,
