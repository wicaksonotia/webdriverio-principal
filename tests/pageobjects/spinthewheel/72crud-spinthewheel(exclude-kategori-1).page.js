...
class ExcludeKategori1 extends Page {
    ...
    get radioButtonExclude() {return $$('[class="mat-radio-container"]')}
    get radioButtonBatasidenganKategori () {return $$('[class="mat-radio-container"]')}
    get dropdownBatasiDenganKategori () {return $('[placeholder="Batasan berdasarkan kategori"]')}
    get checkboxBatasanBerdasarkanKategori () {return $$('[role="option"]')}
    ...
    async batasanBerdasarkanKategori () {
        await this.ContainerPB[1].scrollIntoView()
        await this.dropdownBatasiDenganKategori.click()
