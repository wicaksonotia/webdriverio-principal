...
class STWRewardXP extends Page {
    ...
    get selectNamaTradeProgram () {return $('[formcontrolname="trade_creator_id"]')}
    get searchInputTradeProgram () {return $('[placeholder="Pilih Trade Program"]')}
    get optionTradeProgram () {return $$('[class="mat-option ng-star-inserted mat-active"]')}
    get popUpCalendar () { return $('mat-datepicker-content tbody.mat-calendar-body')}
    get calendarMulaiDari () {return $('[formcontrolname="start_date"]')}
    get popupJamTerbit () {return $('[formcontrolname="start_time"]')}
    get calendarTanggalBerakhir () {return $('[formcontrolname="end_date"]')}
    get popupJamBerakhir () {return $('[formcontrolname="end_time"]')}
    //jam
    ...
    get buttonSimpanSTW () {return $('#btn-simpan')}
    
    get inputSearchSTW () {return $('#search')}
    get iconEdit () {return $('#btn-edit')}
    get roleTab () {return $$('[role="tab"]')}
    get roleTabList () {return $$('[role="tablist"]')}

    get radioButtonFixedPanel () {return $$('[class="mat-radio-container"]')}
    get buttonExport () {return $$('[class="is-danger mat-raised-button"]')}
    get buttonImport () {return $$('[class="is-danger mat-raised-button"]')}
    get buttonKirim () {return $('[class="mat-raised-button mat-primary"]')}
    get buttonCheck () {return $$('[class="confirmation-button mat-raised-button"]')}
    get buttonSimpanTabAudience () {return $$('[class="confirmation-button mat-raised-button"]')}

    get frekuensiBelanjaMingguan () {return $('[formcontrolname="shop_freq"]')}
    get maksimalFrekuensiReward () {return $('[formcontrolname="reward_freq"]')}
    get radioButtonPembatasanProdukdanKategori () {return $('[class="mat-radio-container"]')}
    get radioButtonBatasidenganProduk () {return $$('[class="mat-radio-container"]')}
    get inputSearchBatasanBerdasarkanProduk () {return $('[formcontrolname="product"]')}
    get optionBatasanBerdasarkanProduk () {return $$('[role="option"]')}
    get inputNilaiTransaksiMinimal () {return $$('[formcontrolname="value"]')}
    ...
    get buttonReward () {return $$('[class="mat-raised-button mat-primary ng-star-inserted"]')}
    get buttonRewardNonCoin () {return $$('[class="mat-raised-button mat-primary ng-star-inserted"]')}
    get buttonDelete () {return $$('[class="mat-icon-button mat-primary ng-star-inserted"]')}
    get inputCoin () {return $$('[formcontrolname="value"]')}
    get inputSlice () {return $$('[formcontrolname="slice"]')}
    get inputProbability () {return $$('[formcontrolname="probability"]')}
    get btnSimpanPengaturanMekanisme () {return $('[class="confirmation-button mat-raised-button"]')}
    get ContainerPB () {return $$('[class="p-16"]')}
    get inputNamaProgramPreview () {return $('[formcontrolname="preview_header"]')}
    get buttonSimpanPreview () {return $('#btn-simpan')}
    get buttonPublish () {return $('[class="ml-24 confirmation-button mat-raised-button"]')}
    ...
    async batasanBerdasarkanProduk (batasan_berdasarkan_produk) {
        //await this.ContainerPB[0].scrollIntoView()
        await this.inputSearchBatasanBerdasarkanProduk.setValue(batasan_berdasarkan_produk)
        await browser.pause(3000)
