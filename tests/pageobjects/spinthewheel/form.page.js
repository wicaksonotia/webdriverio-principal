...
class FormSpinTheWheelPage extends Page {
    ...
    get btnCreate () { return $('#btn-create-trade') }

    get tab () { return $$('[class="mat-tab-label mat-ripple ng-star-inserted"]') }

    //tab Spin The Wheel
    get inpNamaProgram () { return $('[placeholder="Nama Program"]') }
    get ddTP () { return $('[formcontrolname="trade_creator_id"]') }
    get searchTP () { return $('[aria-label="dropdown search"]') }
    get selectTP () { return $$('[class="mat-option ng-star-inserted mat-active"]') }
    get selectDate () { return $$('[aria-label="Open calendar"]') }
    get popUpCalendar () { return $('mat-datepicker-content tbody.mat-calendar-body') }

    //tabAudience
    get redBox () { return $('[class="box-red"]') }
    get audienceFilterPB () { return $('[value="population-blast"]') }
    get listbox () { return $$('[role="listbox"]') }
    get option () { return $$('[role="option"]') }
    get audienceFilterFP () { return $('[value="fixed-panel"]') }
    get btnExportImport () { return $$('[class="is-danger mat-raised-button"]') }
    get btnKirim () {return $('[class="mat-raised-button mat-primary"]')}
    get btnCheck () { return $$('[class="confirmation-button mat-raised-button"]') }

    //tabPengaturanMekanisme
    get inpFrekBelanja () { return $('[formcontrolname="shop_freq"]') }
    get inpFrekReward () { return $('[formcontrolname="reward_freq"]') }
    get rbPembatasanProdukKategoriExclude () { return $$('[class="mat-radio-container"]') }
    get clPembatasanProdukKategoriExclude () { return $$('[class="mat-radio-container"]') }
    get ddBatasanProdukKategori () { return $('[formcontrolname="category"]') }
    get ddBatasanExclude () { return $('[formcontrolname="category_srcc"]') }
    get option () { return $$('[role="option"]') }
    get inpMinTransaction () { return $('[formcontrolname="minimum_transaction"]') }
    get inpLimitSpin () { return $('[formcontrolname="limit_spin"]') }
    get inpVariasiKoin () { return $('[formcontrolname="coin_variation"]') }
    get inpCoinSliceProb () { return $$('[type="number"]') }

    //tabPreview
    get inpPreviewHeader () { return $('[formcontrolname="preview_header"]') }
    get uploadImage () { return $('[class="rectangle-16"]') }
    get btnPublish () { return $('[class="ml-24 confirmation-button mat-raised-button"]') }
    ...
    async pengaturanSTWPB (frekbel, frekrew, min, limit, varkoin, coin1, slice1, prob1, coin2, slice2, prob2, coin3, slice3, prob3) {
    ...
    async pengaturanSTWFP (frekbel, frekrew, min, limit, varkoin, coin1, slice1, prob1, coin2, slice2, prob2) {
        await this.inpFrekBelanja.addValue(frekbel)
        await this.inpFrekReward.addValue(frekrew)
