...
class RewardCoinNoncoinXP extends Page {
    ...
    get btnTambahTier () {return $('[class="mat-raised-button ng-star-inserted"]')}
    get inputMaksimumNilaiTransaksi () {return $$('[formcontrolname="maximum_transaction"]')}
    ...
    async minimumNilaiTransaksiT1 (minimum_nilai_transaksi_t1) {
        ...
        await this.inputMinimumNilaiTransaksi[0].setValue(minimum_nilai_transaksi_t1);
        await browser.pause(1000)
    }

    async maksimumNilaiTransaksiT1 (maksimum_nilai_transaksi_t1) {
        //await this.inputMinimumNilaiTransaksi.scrollIntoView()
        await this.inputMaksimumNilaiTransaksi[0].setValue(maksimum_nilai_transaksi_t1);
        await browser.pause(1000)
    }
