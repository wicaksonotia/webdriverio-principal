...
class stwBatasanKategori1OR extends Page {
    ...
    get bunttonRewardNonCoin () {return $$('[class="mat-raised-button mat-primary ng-star-inserted"]')}
    ...
    get radioButtonBatasidenganKategori () {return $$('[class="mat-radio-container"]')}
    get dropdownBatasanBerdasarkanKategori () {return $('[formcontrolname="category"]')}
    get optionBatasanBerdasarkanKategori () {return $$('[role="option"]')}
