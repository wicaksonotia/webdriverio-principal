...
class STWPushNotif extends Page {
    ...
    get titlePage () {return $('#headerSpinTheWheelNotifikasi')}
    get inputJudul () {return $('[formcontrolname="title"]')}
    get inputDeskripsi () {return $('[formcontrolname="content"]')}
    get calendarTanggalMulai () {return $('[formcontrolname="start_date"]')}
    ...
    get timeSetWaktu () {return $('[formcontrolname="at"]')}
    //jam
    ...
    get jam00 () {return $('[style="transform: rotateZ(-720deg);"]')}
    get timebtnOK () {return $$('[class="timepicker-button"][type="button"]')} 
    get dropdownIntervalPengiriman () {return $('[formcontrolname="day"]')}
    get selectDay () {return $$('[role="option"]')}
