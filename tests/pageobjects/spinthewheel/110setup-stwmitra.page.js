...
class SetupStwMitraPage extends Page {
    ...
    get titlePage () {return $('#headerSpinTheWheelMitraSetup')}
    get table () {return $('[class="ayo-middle py-24"]')}
    get titletable () {return $$('[class="px-24"]')}
    get inputJudul () {return $('[formcontrolname="title"]')}
    get inputDeskripsi () {return $('[formcontrolname="content"]')}
    get popupTanggalMulai () {return $('[formcontrolname="started_at"]')}
    get popupTanggalBerakhir () {return $('[formcontrolname="ended_at"]')}
    get popUpCalendar () { return $('mat-datepicker-content tbody.mat-calendar-body')}
    get popupSetWaktu () {return $('[formcontrolname="at"]')}
    //jam
    ...
    get dropdownIntervalProgram () {return $('[formcontrolname="day"]')}
    get checkboxDay () {return $$('[role="option"]')}
    get buttonSimpan () {return $('#btn-simpan')}
