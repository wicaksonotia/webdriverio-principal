...
class crudPemenangdanUndian extends Page {
    ...
    get titleUbahUndian () {return $('#contentHeader > div > div.white-fg > span:nth-child(5)')}
    get tab () {return $('[class="mat-tab-labels"]')}
    get inputNamaProgram () {return $('[formcontrolname="name"]')}
    get inputJumlahKoin () {return $('[formcontrolname="coin"]')}
    get calendarAwalPenukaranKupon () {return $('[formcontrolname="start_date"]')}
    get calendarBerakhirPenukaranKupon () {return $('[formcontrolname="end_date"]')}
    get calendarPengumumanPemenang () {return $('[formcontrolname="announcement_date"]')}
    ...
    get popupJamPengumumanPemenang () {return $('[formcontrolname="announcement_time"]')}
    //jam
    ...
    get selectSubGroupTradeProgram () {return $('[formcontrolname="sub_group_trade_program"]')}
    get inputSubGrupTradeProgram () {return $('[placeholder="Cari Sub Group Trade Program..."]')}
    get checkboxSGTP () {return $('[class="mat-option-pseudo-checkbox mat-pseudo-checkbox ng-star-inserted"]')}
    get buttonSimpan () {return $('#btn-simpan-trade')}

    get roleTab () {return $$('[role="tab"]')}
    //audience
    get radioButtonFixedPanel () {return $$('[class="mat-radio-container"]')}
    get Gambar () {return $$('[class="rectangle-16"]')}
    get buttonExport () {return $$('[class="is-danger mat-raised-button"]')}
    get buttonImport () {return $$('[class="is-danger mat-raised-button"]')}
    get ButtonCheckAu () {return $$('[class="confirmation-button mat-raised-button"]')}
    get BtnSimpanAu () {return $('#btn-simpan')}
    get buttonKirim () {return $('[class="mat-raised-button mat-primary"]')}
    get buttonBatal () {return $('[class="mat-stroked-button mat-primary"]')}

    //preview
    get inputIsiHalaman () {return $$('[contenteditable="true"]')}
    get clickToggleBar () {return $('[class="mat-slide-toggle-bar"]')}
    get buttonSimpanPreview () {return $('[class="confirmation-button mat-raised-button"]')}
    get buttonDownloadListPemenang () {return $('[class="is-danger mat-raised-button"]')}
    get buttonSimpanListPemenang () {return $('#btn-simpan')}
    get buttonPublish () {return $('#btn-create-trade')}
