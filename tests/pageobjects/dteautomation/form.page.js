...
class FormDTEAutomationPage extends Page {
    ...
    get titlePage () { return $('#headerDteAutomation') } //Create
    get titlePageNonTsm () { return $('#headerDteAutomation-NonTsm') } //Detail/Edit
    get titlePageTsm () { return $('#headerDteAutomation-Tsm') } //Detail/Edit
    
    get btnSimpan () { return $('button.confirmation-button') }

    get type () { return $$('label[class="mat-checkbox-layout"] > div') } //Shareable Link, Exclude Transaction GSM
    get searchInput () {return $$('[placeholder="Cari"]')}
    get drpdwnAutomation () { return $('mat-select[formcontrolname="automation"]') }
    get selectAutomation () { return $$('mat-option[role="option"] > span') } // E-Order, Digital Coupon, Referral Code

    get drpdwnJenisTantanganEOrder () { return $('mat-select[formcontrolname="jenis_tantangan"]') }
    get selectJenisTantanganEOrder () { return $$('mat-option[role="option"] > span') } // Default, Minimum Transaction Frequency, Extra Coin

    get drpdwnTradeProgram () { return $('mat-select[formcontrolname="trade_program_id"]') }
    get searchTradeProgram () { return $('div > input.mat-select-search-input') }
    get selectTradeProgram () { return $$('mat-option[role="option"] > span') }

    //Durasi
    get startDatePenukaranKoin () { return $('input[formcontrolname="startDate"]') }
    get selectStartDatePenukaranKoin () { return $('[class="mat-calendar-body"]') }
    get endDatePenukaranKoin () { return $('input[formcontrolname="endDate"]') }
    get selectEndDatePenukaranKoin () { return $('[class="mat-calendar-body"]') }

    get totalKupon () { return $('input[formcontrolname="coupon_total"]')}
    get coinRewardperFrekuensi () { return $('input[formcontrolname="coin_reward"]') }
    get frekuensi () { return $('input[formcontrolname="coin_max"]') }

    get drpdwnBarcodeSKUTarget () { return $('mat-select[placeholder="Cari Barcode SKU yang di targetkan"]') }
    get searchBarcodeSKUTarget () { return $('div > input.mat-select-search-input') }
    get btnXsearchBarcodeSKUTarget () { return $('ngx-mat-select-search > div > button') }
    get selectBarcodeSKUTarget () { return $$('mat-option[role="option"] > div') }
    get btnAddProduct () { return $('div.mt-8.px-24 > div > div > button') }

    get judulTantangan () { return $('input[formcontrolname="title_challenge"]') }
    get deskripsiTantangan () { return $('input[formcontrolname="description_challenge"]') }
    get teksButton () { return $('input[formcontrolname="button_text"]') }
    
    //Notifikasi Tambahan
    get notif () { return $$('mat-radio-group[role="radiogroup"]') } //Ya, Tidak
    get notifYa () { return $$('mat-radio-group[formcontrolname="notif"] > mat-radio-button') } //H+1, H+2, H+3
    ...
    async selectDate () {
        ...
        await this.selectStartDatePenukaranKoin.$$('tr')[4].$$('td')[5].$('div').click()
        await this.endDatePenukaranKoin.click()
        await this.selectEndDatePenukaranKoin.$$('tr')[4].$$('td')[6].$('div').click()
    }
