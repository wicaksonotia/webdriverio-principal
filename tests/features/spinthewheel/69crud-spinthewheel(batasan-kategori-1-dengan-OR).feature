Feature: 69. CRUD Spin The Wheel (batasan-kategori-1-dengan-OR)
  ...
  Scenario Outline: As a user, I can create Spin The Wheel batasan kategori 1 dengan OR
    ...
    When I click button Reward Non coin1
    Then System should be show input form1

    When I input non coin1 <noncoin1>
    Then System should be input non coin1

    When I click button Reward Non coin2
    Then System should be show input form2

    When I input non coin2 <noncoin2>
    Then System should be input non coin2
...
Examples:
      | nama_program                            | nama_trade_program | frekuensi_belanja | maksimal_frekuensi | nilai_transaksi_minimal1 | nilai_transaksi_minimal2 | minimum_nilai_transaksi | limit_spin | noncoin1 | noncoin2  | slice1 | slice2 | probability1 | probability2 |
      | stw-batasan-kategori-1-OR Testing Reda  | Trade Program Reda | 1                 | 1                  | 20000                    | 5000                    | 10000                   | 2          | payung   | sepatu    | 2      | 3      | 50           | 50           |
