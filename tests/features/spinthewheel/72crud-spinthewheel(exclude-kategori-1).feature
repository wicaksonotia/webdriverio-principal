Feature: 72. CRUD Spin The Wheel (exclude-kategori-1)
  ...
  Scenario Outline: As a user, I can create Spin The Wheel exclude kategori 1
    ...
    When I select data in Batasan Berdasarkan Kategori
    Then System should be able to select data in Batasan Berdasarkan Kategori
    ...
    When I input coin3 <coin3>
    Then System should be input coin3
    ...
    When I input slice4 <slice4>
    Then System should be input slice4
    ...
    When I input probability4 <probability4>
    Then System should be input probability4
...
Examples:
      | nama_program                        | nama_trade_program | frekuensi_belanja | maksimal_frekuensi | minimum_nilai_transaksi | limit_spin | jumlah_variasi_koin | coin1 | coin2 |coin3 | noncoin | slice1 | slice2 | slice3 | slice4 | probability1 | probability2 | probability3 | probability4 |
      | stw-exclude-kategori1 Testing Reda  | Trade Program Reda | 1                 | 1                  | 10000                   | 3          | 3                   | 10    | 20    |30    | tas     | 3      | 3      |3       | 3      |  25          | 25           | 25           | 25           |
