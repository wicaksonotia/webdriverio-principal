Feature: 65. CRUD Spin The Wheel (batasan-produk-1)
...
Examples:
      | nama_program                       | nama_trade_program | batasan_berdasarkan_produk | frekuensi_belanja | maksimal_frekuensi | nilai_transaksi_minimal | minimum_nilai_transaksi | limit_spin | jumlah_variasi_koin | coin1 | coin2 | coin3 | slice1 | slice2 | slice3 | probability1 | probability2 | probability3 |
      | STW Batasan Produk 1 Testing Reda  | Trade Program Reda | Marlboro Red 20            | 2                 | 3                  | 18000                   | 10000                   | 10         | 3                   | 30    | 40    | 50    | 5      | 5      | 3      | 40           | 40           | 20           |
