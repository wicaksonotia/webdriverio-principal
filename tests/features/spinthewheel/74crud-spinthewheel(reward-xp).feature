Feature: 74. CRUD Spin The Wheel (reward-xp)
  ...
  Scenario Outline: As a user, I can create Spin The Wheel reward xp
    ...
    When I click button Reward Non coin and delete
    Then System should be show input form non coin and delete

    When I click button Reward XP and delete
    Then System should be show input form Reward XP and delete

    When I click button Reward XP
    Then System should be show input form Reward XP
...
Examples:
      | nama_program        | nama_trade_program | batasan_berdasarkan_produk           | frekuensi_belanja | maksimal_frekuensi | nilai_transaksi_minimal | minimum_nilai_transaksi | limit_spin | xp | slice | probability | 
      | STW-reward-xp-reda  | Trade Program Reda | Eskulin Splash Clg Blossom Ice 125ml | 1                 | 1                  | 45000                   | 10000                   | 2          | 20 | 2     | 100         |
