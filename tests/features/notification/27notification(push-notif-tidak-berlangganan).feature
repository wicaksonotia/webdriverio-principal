Feature: 27. Push Notifikasi (push-notif-tidak-berlangganan)

  Scenario Outline: As a user, I can Create Push Notifikasi Tidak Berlangganan
    ...
    When I select Tidak Berlangganan only in Filter Pengguna Tipe Berlangganan
    Then System should be select Tidak Berlangganan only
    ...
    Examples:
      ...
      | push notif tidak berlangganan Testing Reda | push notif tidak berlangganan Testing Reda | push notif tidak berlangganan Testing Reda  | push notif tidak berlangganan Testing Reda |
