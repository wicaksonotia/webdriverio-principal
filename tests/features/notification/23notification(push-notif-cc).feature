Feature: 23. Push Notifikasi (push-notif-cc)

  Scenario Outline: As a user, I can Create Push Notifikasi cc
    ...
    Examples:
      ...
      | push notif cc Testing Reda | push notif cc Testing Reda | push notif cc Testing Reda | push notif cc Testing Reda |
