Feature: 17. Popup Notifikasi (popup-notifikasi-cc)

  Scenario Outline: As a user, I can Create Popup Notifikasi CC
    ...
    Then System should be click radio button CC
    ...
    Examples:
      ...
      | popup notifikasi CC Testing Reda   | Yes                | No               |18             |50              | popup notifikasi CC Testing Reda  |
