Feature: 31. B2C Voucher (voucher-tipe-bukan-perokok)

  Scenario Outline: As a user, I can Create Voucher Tipe Bukan Perokok
    ...
    When I select Bukan Perokok in Tipe Customer
    Then System should be select Bukan Perokok in Tipe Customer
