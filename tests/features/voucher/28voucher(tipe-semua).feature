Feature: 28. B2C Voucher (voucher-tipe-semua)

  Scenario Outline: As a user, I can create Voucher Tipe Semua
    ...
    When I select Semua in Tipe Customer
    Then System should be select Semua in Tipe Customer
