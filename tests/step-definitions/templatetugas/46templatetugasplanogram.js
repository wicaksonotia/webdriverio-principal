...
When(/^I fill form and submit$/, async () => {
    ...
    await FormTemplateTugasPage.inputJudulTugas(dataTest.templateTugas.judulPlanogram, dataTest.templateTugas.namaLainPlanogram, dataTest.templateTugas.deskripsiPlanogram)
    ...
    await FormTemplateTugasPage.addNewQuestion()
    await FormTemplateTugasPage.addNewQuestion()
    await FormTemplateTugasPage.selectQstPlanogramIR1(dataTest.templateTugas.qstPlanogram1)
    await FormTemplateTugasPage.selectQstPlanogramIR2(dataTest.templateTugas.qstPlanogram2)
    await FormTemplateTugasPage.selectQstPlanogramIR3(dataTest.templateTugas.qstPlanogram3)
