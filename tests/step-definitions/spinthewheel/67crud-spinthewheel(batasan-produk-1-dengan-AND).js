...
allureReporter.addTestId('[PRINCIPAL] 67. CRUD Spin the Wheel (Batasan > 1 Produk dengan AND)');
allureReporter.addFeature('CRUD Spin the Wheel (Batasan > 1 Produk dengan AND)');
...
Given (/^I am on the Buat Spin The Wheel page$/, async() => {
    ...
    When (/^I search and select data in Batasan Berdasarkan Produk1 (.*)$/, async(batasan_berdasarkan_produk1) => {
    await stwBatasanProduk1AND.batasanBerdasarkanProduk1(batasan_berdasarkan_produk1)
    });
                                            
    Then (/^System should be able to search and select data in Batasan Berdasarkan Produk1$/, async() => {
    await stwBatasanProduk1AND.PengaturanMekanismeTabPage()
    });

    When (/^I search and select data in Batasan Berdasarkan Produk2 (.*)$/, async(batasan_berdasarkan_produk2) => {
    await stwBatasanProduk1AND.batasanBerdasarkanProduk2(batasan_berdasarkan_produk2)
    });
                                                
    Then (/^System should be able to search and select data in Batasan Berdasarkan Produk2$/, async() => {
    await stwBatasanProduk1AND.PengaturanMekanismeTabPage()
    });

    When (/^I input Nilai Transaksi Minimal1 (.*)$/, async(nilai_transaksi_minimal1) => {
    ...
    When (/^I input Nilai Transaksi Minimal2 (.*)$/, async(nilai_transaksi_minimal2) => {
