...
allureReporter.addTestId('[PRINCIPAL] 69. CRUD Spin the Wheel (Batasan > 1 Kategori dengan OR)');
allureReporter.addFeature('CRUD Spin the Wheel (Batasan > 1 Kategori dengan OR)');
...
Given (/^I am on the Buat Spin The Wheel page$/, async() => {
    ...
    When (/^I click dropdown Batasan Berdasarkan Kategori and select data$/, async() => {
