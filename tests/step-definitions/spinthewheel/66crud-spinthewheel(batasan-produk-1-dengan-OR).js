...
allureReporter.addTestId('[PRINCIPAL] 66. CRUD Spin the Wheel (Batasan > 1 Produk dengan OR)');
...
Given (/^I am on the Buat Spin The Wheel page$/, async() => {
    ...
    await stwBatasanProduk1OR.batasanBerdasarkanProduk1(batasan_berdasarkan_produk1)
    });
    ...
    await stwBatasanProduk1OR.batasanBerdasarkanProduk2(batasan_berdasarkan_produk2)
    });
    ...
    When (/^I select radio button OR in Kombinasi Pembatasan Produk Kategori$/, async() => {
