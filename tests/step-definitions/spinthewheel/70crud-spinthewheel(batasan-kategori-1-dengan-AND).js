...
allureReporter.addTestId('[PRINCIPAL] 70. CRUD Spin the Wheel (Batasan > 1 Kategori dengan AND)');
allureReporter.addFeature('CRUD Spin the Wheel (Batasan > 1 Kategori dengan AND)');
