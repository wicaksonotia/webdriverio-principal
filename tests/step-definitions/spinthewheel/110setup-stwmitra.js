...
Given (/^I am on the Spin The Wheel page$/, async() => {
    ...
    Then (/^System should be leading to Buat Spin The Wheel Mitra Setup Page$/, async() => {
...
Given (/^I am on the Buat Spin The Wheel Mitra Setup Page$/, async() => {
    ...
    Then (/^System should be leading to Buat Spin The Wheel Mitra Setup Page2$/, async() => {
    await SetupStwMitraPage.Page()
    });
    ...
    Then (/^System should be able to input Deskripsi Push Notifikasi2$/, async() => {
    await SetupStwMitraPage.Page()
    });
    ...
    Then (/^System should be able to select date in Tanggal Berakhir2$/, async() => {
    await SetupStwMitraPage.Page()
    });
    ...
    Then (/^System should be submit data and leading to Spin The Wheel Page2$/, async() => {
    await SetupStwMitraPage.Page()
    });