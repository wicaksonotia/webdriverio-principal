...
When(/^I create task sequencing and click button Submit$/, async () => {
    ...
    await FormCreatePage.createTSM(dataTest.taskSequencing.nameWithPinUp42, dataTest.tradeProgram.namaTP4, dataTest.audience.audienceToko)
...
When(/^setting Misi and save mission builder$/, async () => {
    ...
    await MissionBuilderPage.setCoin(dataTest.taskSequencing.coinSubmission42, dataTest.taskSequencing.coinVerification42)
