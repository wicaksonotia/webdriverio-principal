...
When(/^I create task sequencing and click button Submit$/, async () => {
    ...
    await FormCreatePage.createTSM(dataTest.taskSequencing.nameWithPinUp4, dataTest.tradeProgram.namaTP4, dataTest.audience.audienceToko)
...
When(/^setting Misi with Pin Up Mission$/, async () => {
    ...
    await MissionBuilderPage.settingMissionWithoutPinUp(dataTest.templateTugas.searchByName4)
