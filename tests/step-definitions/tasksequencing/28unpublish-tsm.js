...
When(/^I search a Task Sequencing$/, async () => {
    await TaskSequencingPage.searchTaskSequencing(dteData.taskSequencing.searchByName28) 
});
...
When(/^I edit a TSM with status 'Aktif' and submit task sequencing$/, async () => {   
...
Then(/^System should be able to unpublish TSM, and leading to Task Sequencing page with status changed to 'Tidak Aktif'$/, async () => {   
    await TaskSequencingPage.page()
