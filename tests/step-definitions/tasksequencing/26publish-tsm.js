...
When(/^I edit a TSM with status 'Tidak Aktif' and submit task sequencing$/, async () => {   
...
Then(/^System should be able to publish TSM, and leading to Task Sequencing page with status changed to 'Aktif'$/, async () => {   
    await TaskSequencingPage.page()
