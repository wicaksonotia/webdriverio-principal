...
When(/^I add assignment then go to Verification Assignment page$/, async () => {
    await AssignmentCartPage.searchTaskVerif(dataTest.taskVerification.searchByTsmName7) 
    //await AssignmentCartPage.searchResult(dataTest.taskVerification.searchByTsmName7)
    await browser.pause(10000)
...
When(/^I click button verify a TSM Task Verification$/, async () => {
    await VerificationApprovalPage.searchTaskVerif(dataTest.taskVerification.searchByTsmName7) 
    await VerificationApprovalPage.searchResult(dataTest.taskVerification.searchByTsmName7)
    await browser.pause(10000)
