...
Given (/^I am on the Undian page$/, async() => {
    ...
    When (/^I input jumlah koin yang dibutuhkan per kupon (.*)$/, async(jumlah_koin) => {
    await crudPemenangdanUndian.jumlahKoin(jumlah_koin)
    });
                
    Then (/^System should be input jumlah koin yang dibutuhkan per kupon$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be input date in Tanggal awal penukaran kupon undian$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be select date in Tanggal Berakhir Penukaran Kupon Undian$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be select date in Tanggal Pengumuman Pemenang Berakhir$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be select time in Jam Pengumuman Pemenang Berakhir$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be select Sub GTP Weekend 2023 in Sub Group Trade Program$/, async() => {
    await crudPemenangdanUndian.Page()
    });
    ...
    Then (/^System should be submit data in Tab Undian and leading to Undian Page$/, async() => {
    await undianPage.pageUndian()
    });
    ...
    Then (/^System should be submit data and close popup Unggah File XLSX$/, async() => {
    await crudPemenangdanUndian.AudienceTabPage()
    });
    ...
    When (/^I search and click button Delete in Undian Page (.*)$/, async(nama_program) => {
    await undianPage.Search(nama_program)
